...
from ffeast.server import application
from ffeast.framework.db import metadata, engine, Model, get_redis_connection
...
def api_specification(role_name, email='foo@bar.com', password='123'):
    ...
    def prepare_token(context):
        ...
        context.headers = {'X-FFeast-Token': context.token}
