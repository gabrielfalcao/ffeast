...
from ffeast.framework.core import Application, ErrorHandlers


@patch('ffeast.framework.core.Flask')
def test_application_has_flask_app(Flask):
    ...
    Flask.assert_called_once_with('ffeast.framework.core')
...
@patch('ffeast.framework.core.ErrorHandlers')
@patch('ffeast.framework.core.Flask')
...
@patch('ffeast.framework.core.RedisSessionInterface')
@patch('ffeast.framework.core.Flask')
...
@patch('ffeast.framework.core.AssetsManager')
@patch('ffeast.framework.core.Flask')
...
@patch('ffeast.framework.core.Manager')
@patch('ffeast.framework.core.Flask')
...
@patch('ffeast.framework.core.log')
@patch('ffeast.framework.core.Flask')
...
def test_setup_logging(Flask, log):
    ...
    log.get_logger.assert_has_calls([
        call('ffeast'),
        call('ffeast.api.models'),
        call('ffeast.api.resources'),
        call('ffeast.framework.http'),
        call('ffeast.framework.db'),
    ])

    # And setup_handler_for_logger should have been called for each handler
    app.setup_handler_for_logger.assert_has_calls([
        call('handler for [ffeast]', output, logging.WARNING),
        call('handler for [ffeast.api.models]', output, logging.WARNING),
        call('handler for [ffeast.api.resources]', output, logging.WARNING),
        call('handler for [ffeast.framework.http]', output, logging.WARNING),
        call('handler for [ffeast.framework.db]', output, logging.WARNING),

   ])


@patch('ffeast.framework.core.os')
@patch('ffeast.framework.core.RedisSessionInterface')
@patch('ffeast.framework.core.Flask')
...
@patch('ffeast.framework.core.render_template')
