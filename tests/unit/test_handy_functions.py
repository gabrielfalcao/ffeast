...
from ffeast.framework.handy.functions import (
    slugify,
    empty,
    now,
    geo_data_for_ip,
...
@patch('ffeast.framework.handy.functions.datetime')
...
@patch('ffeast.framework.handy.functions.request')
...
@patch('ffeast.framework.handy.functions.PyGEOIP')
