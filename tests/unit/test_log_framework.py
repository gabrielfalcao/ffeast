...
from ffeast.framework.log import (
    ColorFormatter,
...
@patch('ffeast.framework.log.settings')
@patch('ffeast.framework.log.logging')
...
@patch('ffeast.framework.log.settings')
@patch('ffeast.framework.log.logging')
@patch('ffeast.framework.log.ColorFormatter')
...
@patch('ffeast.framework.log.logging')
@patch('ffeast.framework.log.datetime')
