...
from ffeast.framework.http import (
    absolute_url,
    ssl_absolute_url,
...
@patch('ffeast.framework.http.settings')
...
@patch('ffeast.framework.http.request')
...
@patch('ffeast.framework.http.set_cors_into_headers')
@patch('ffeast.framework.http.json_response')
...
@patch('ffeast.framework.http.current_app')
@patch('ffeast.framework.http.set_cors_into_headers')
...
@patch('ffeast.framework.http.Response')
@patch('ffeast.framework.http.json')
