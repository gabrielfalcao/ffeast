...
from ffeast.framework.formats.json import json_converter, loads, dumps
...
@patch('ffeast.framework.formats.json.json')
...
@patch('ffeast.framework.formats.json.json')
@patch('ffeast.framework.formats.json.json_converter')
