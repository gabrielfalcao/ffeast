...
class Application(object):
    ...
    Welcome to the FFeast Application!
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    This class is the backbone of the FFeast application: it knows
    ...
    def __init__(self, settings_path='ffeast.settings', *args, **kwargs):
        self.assets = None
    ...
    def enable_commands(self, commands):
        ...
        """
        # Ensure local mode
        os.environ.setdefault("FFEAST_LOCAL_MODE", "true")
    ...
    def from_env(CreateApplication,
                 environment_variable_name='FFEAST_SETTINGS_MODULE',
                 fallback_module_name='ffeast.settings',
                 *flask_args,
                 **flask_kwargs
        ):
